    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title"><i class="fas fa-user-edit me-2 text-primary"></i>تعديل مستخدم</h5>
            </div>
            <div class="card-body">
                <form action="<?= base_url('users/update/' . $user['id']) ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">كلمة المرور الجديدة (اتركه فارغاً للحفاظ على الحالي)</label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="role_id" class="form-select" required>
                                ...
                                <option value="<?= $role['id'] ?>" <?= $user['role_id'] == $role['id'] ? 'selected' : '' ?>><?= $role['name_ar'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
